                ...
                <nav class="navigation">
                    <ul class="navigation__list">
                        <li class="navigation__item">
                            <a href="#" class="navigation__links">Акции</a>
                        </li>
                        <li class="navigation__item">
                            <a href="#" class="navigation__links">Каталог</a>
                        </li>
                        <li class="navigation__item">
                            <a href="#" class="navigation__links">Доставка</a>
                        </li>
                        <li class="navigation__item">
                            <a href="#" class="navigation__links">О магазине</a>
                        </li>
                        <li class="navigation__item">
                ...
                <div class="cart">
                    <button class="cart__button">
                        <img
                            ...
                            class="cart__image"
                        />
                        <span class="cart__summary">2 228 руб.</span>
                    </button>
                </div>
            </div>
        </div>
